...
@export var should_return_to_previous: bool = true
...
func _check_tween():
	...
	if not tween.is_connected("tween_completed", Callable(self, "_on_tween_finished")):
		tween.connect("tween_completed", Callable(self, "_on_tween_finished"))
